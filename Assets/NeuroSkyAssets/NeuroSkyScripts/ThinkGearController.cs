...
public class ThinkGearController : MonoBehaviour {
	...
	private void OnUpdateMeditationEvent(int value)
	{
	}
    ...
    */
    void receiveConnectState1(string value){
	    Debug.Log("Receive connect state");
